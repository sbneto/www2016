...
% (this `would be a place to critique the Mexican desensitization to violence paper).

%As users experience with changes with Community 1: The nature or goals of the community can change.  Flixter.  Digg.  Reddit iteself has a number of subcommunities that are the default set for new users---and they change over time. 
