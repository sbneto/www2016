...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.42]{./images/avr_posts_per_user_over_time_total.eps}
\subimage[width=0.48, scale=0.42]{./images/avr_posts_per_user_user_ref_total.eps}
...
\vspace{5pt} % fixing header in wrong page
