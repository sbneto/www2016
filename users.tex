...
%% DC 15: Fair enough; will integrate this with that.  Part of me wonders if it's easier to hypothesize in the context of the results, but having it all collected in the discussion is useful for making clear that we're _not_ claiming we _know_ the things we're speculating about. 
...
%It is important to highlight here that we are not talking about the average number of comments a submission gets, but how many comments a user authors for each of his/her submissions. 
